!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).OSC = e());
})(this, function () {
  "use strict";
  function t(t, n, r) {
    return (
  ...
  function D(t) {
    ...
    if (w(t))
      return (
        (e = t).length > 1 && "/" === e[e.length - 1] && (e = e.slice(0, e.length - 1)),
        e.length > 1 && "/" !== e[0] && (e = "/".concat(e)),
        e
      );
  ...
  var M = a(
      ...
      [
        ...
        },
        {
          key: "merge",
          value: function () {
            var t = new Uint8Array(this.byteLength),
              e = 0;
            return (
  ...
  var N = (function (e) {
        ...
        a(n, [
          {
            ...
            value: function () {
              ...
              for (
                var t = "".concat(this.value, "\0"), e = P(t.length), n = new Uint8Array(e), r = 0;
                r < t.length;
                r += 1
              )
                n[r] = t.charCodeAt(r);
    ...
    _ = (function (e) {
      function n() {
        ...
        i(this, n);
        var r = new U();
        return e instanceof U ? (r = e) : d(e) ? r.timestamp(e) : E(e) && r.timestamp(e.getTime()), t(this, n, [r]);
      }
      return (
        c(n, e),
        a(n, [
    ...
    G = BigInt("9223372036854775807"),
    Z = BigInt("-9223372036854775808"),
    q = (function (e) {
      function n(e) {
        if ((i(this, n), e && "bigint" != typeof e))
        ...
        var r;
        return e && (r = BigInt.asIntN(64, e)), t(this, n, [r]);
      }
      return (
        c(n, e),
        a(n, [
    ...
    K = (function (e) {
      function n(e) {
        ...
        var r;
        return e && (r = BigInt.asUintN(64, e)), t(this, n, [r]);
      }
      return (
        c(n, e),
        a(n, [
    ...
    tt = a(
      ...
      [
        ...
        },
        {
          ...
          value: function () {
            var t = this;
            if (0 === this.address.length || "/" !== this.address[0])
        ...
        },
        {
          ...
          value: function (t) {
            ...
            n.unpack(t, e);
            var r = new N();
            if ((r.unpack(t, n.offset), 0 === n.value.length || "/" !== n.value[0]))
              throw new Error("OSC Message found malformed or missing address string");
            if (0 === r.value.length && "," !== r.value[0])
    ...
    et = (function (e) {
      function n(e) {
        ...
        return (
          a.length > 0 && a[0] instanceof Array && (o = a.shift()),
          (r = t(this, n, [e, o])),
          a.length > 0 &&
            ((r.types = a
              .map(function (t) {
    ...
    rt = (function () {
      function t() {
        ...
        r.length > 0 &&
          (r[0] instanceof Date || d(r[0])
            ? (this.timetag = new _(r[0]))
            : k(r[0])
            ? (r[0].forEach(function (t) {
                e.add(t);
              }),
              r.length > 1 && (r[1] instanceof Date || d(r[1])) && (this.timetag = new _(r[1])))
      ...
      return a(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              t.add(new N(nt)),
              this.timetag || (this.timetag = new _()),
              t.add(this.timetag),
              this.bundleElements.forEach(function (e) {
    ...
    ot = a(
      function t(e) {
        if ((i(this, t), e && !(e instanceof et || e instanceof rt)))
      ...
      [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              r.unpack(t, e),
              (n = r.value === nt ? new rt() : new et()).unpack(t, e),
    ...
    it = { discardLateMessages: !1 },
    st = a(
      function t(e) {
        i(this, t),
          (this.options = r(r({}, it), e)),
          (this.addressHandlers = []),
          (this.eventHandlers = { open: [], error: [], close: [] }),
          (this.uuid = 0);
      },
      [
        {
          ...
          value: function (t, e) {
            ...
            if (t.value instanceof rt) {
              ...
              return r.bundleElements.forEach(function (t) {
                if (t instanceof rt) {
                  if (r.timetag.value.timestamp() < t.timetag.value.timestamp())
        ...
        },
        {
          ...
          value: function (t, e, n) {
            var r = !1;
            if (w(t) && t in this.eventHandlers)
              return (
            ...
            var o = Object.keys(this.addressHandlers),
              i = this.addressHandlers;
            return (
              o.forEach(function (o) {
                var s = !1,
                  a = new RegExp(B(D(t)), "g");
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            this.uuid += 1;
            var n = { id: this.uuid, callback: e };
            if (w(t) && t in this.eventHandlers) return this.eventHandlers[t].push(n), this.uuid;
            var r = D(t);
            return (
              r in this.addressHandlers || (this.addressHandlers[r] = []), this.addressHandlers[r].push(n), this.uuid
            );
          },
        },
        {
          ...
          value: function (t, e) {
            ...
            var n, r;
            return (
              w(t) && t in this.eventHandlers
                ? ((n = t), (r = this.eventHandlers))
                : ((n = D(t)), (r = this.addressHandlers)),
              n in r &&
                r[n].some(function (t, o) {
    ...
    at = a(
      function t() {
        if ((i(this, t), this.constructor === t))
          ...
          },
          {
            ...
            value: function () {
              var t = this,
                ...
                n = r(r({}, this.options.open), e),
                o = n.port,
                i = n.exclusive;
              (this.socketStatus = ut),
                this.socket.bind({ address: n.host, port: o, exclusive: i }, function () {
  ...
  var pt =
      "undefined" != typeof WebSocket
        ...
        ? self.WebSocket || self.MozWebSocket
        : void 0,
    dt = void 0,
    vt = 0,
    wt = 1,
    ...
    gt = 3,
    kt = {
      udpServer: { host: "localhost", port: 41234, exclusive: !1 },
  ...
  var mt = (function (e) {
          ...
          },
          {
            ...
            value: function () {
              var t = this,
                e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = bt(this.options, e);
              (this.socketStatus = vt),
                this.socket.bind(
                  { address: n.udpServer.host, port: n.udpServer.port, exclusive: n.udpServer.exclusive },
                  function () {
                    var e = {};
                    n.wsServer.server ? (e.server = n.wsServer.server) : (e = n.wsServer),
                      (t.websocket = new dt(e)),
                      (t.websocket.binaryType = "arraybuffer"),
                      t.websocket.on("listening", function () {
                      ...
                      t.websocket.on("connection", function (e) {
                        e.on("message", function (e, n) {
                          t.send(e, { receiver: "udp" }), t.notify(new Uint8Array(e), n);
                        });
                      });
                  }
                );
    ...
    Ct = 2,
    Pt = 3,
    At = { host: "localhost", port: 8080, secure: !1, protocol: [] },
    It = (function (e) {
      function n(e) {
        var o;
        ...
        a(n, [
          ...
          },
          {
            ...
            value: function () {
              ...
              var u = s ? "wss" : "ws",
                c = { address: i, family: u, port: o, size: 0 };
              (this.socket = new pt("".concat(u, "://").concat(i, ":").concat(o), a)),
                (this.socket.binaryType = "arraybuffer"),
                (this.socketStatus = Et),
          ...
          },
          {
            ...
            value: function () {
              var t = this,
                ...
                o = n.port,
                i = n.host,
                s = { address: i, family: "wsserver", port: o, size: 0 };
              this.socket && this.close(),
                n.server ? (this.socket = new dt({ server: n.server })) : (this.socket = new dt({ host: i, port: o })),
                (this.socket.binaryType = "arraybuffer"),
                (this.socketStatus = jt),
    ...
    Tt = { discardLateMessages: !1 },
    Ht = a(
      function t(e) {
        if ((i(this, t), e && !b(e))) throw new Error("OSC options argument has to be an object.");
        (this.options = r(r({}, Tt), e)),
          this.options.plugin || (this.options.plugin = new It()),
          (this.eventHandler = new st({ discardLateMessages: this.options.discardLateMessages }));
      ...
      [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (!this.options.plugin || !m(this.options.plugin.open))
        ...
        },
        {
          key: "status",
          value: function () {
            if (!this.options.plugin || !m(this.options.plugin.status))
        ...
        },
        {
          key: "close",
          value: function () {
            if (!this.options.plugin || !m(this.options.plugin.close))
        ...
        },
        {
          key: "send",
          value: function (t, e) {
            if (!this.options.plugin || !m(this.options.plugin.send))
              throw new Error("OSC Plugin API #send is not implemented!");
            if (!(t instanceof tt || t instanceof et || t instanceof rt || t instanceof ot))
  ...
  return (
    (Ht.STATUS = { IS_NOT_INITIALIZED: -1, IS_CONNECTING: 0, IS_OPEN: 1, IS_CLOSING: 2, IS_CLOSED: 3 }),
    (Ht.Packet = ot),
    (Ht.Bundle = rt),
    (Ht.Message = et),
    (Ht.TypedMessage = tt),
    (Ht.Plugin = at),
    (Ht.DatagramPlugin = ht),
    (Ht.WebsocketClientPlugin = It),
    (Ht.WebsocketServerPlugin = xt),
    (Ht.BridgePlugin = mt),
    Ht
  );
});
